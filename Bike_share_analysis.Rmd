...
# Ask - **Navigating Cyclitics Challenge and Objectives**
...
```{r}
# Save the path string in a variable
project_path <- "D:/cycliticsBikeShareAnalysis"

# Set the working directory to the location of the .Rmd file
setwd(here::here(project_path))

# Specify the full path to the "Subset_2023" folder
data_folder <- here::here(project_path, "Subset_2023")

# List all CSV files in the "Subset_2023" folder
...
write.csv(merged_data, here::here(project_path, "Merged_Data_2023.csv"), row.names = FALSE)
```

```{r}
merged_data <- read.csv("D:/cycliticsBikeShareAnalysis/Merged_Data_2023.csv")
```
